...
//                => this.Add(new Turn().SetName(name), initiator, OutcomeProp, dice);
...
//            where TInitiator : RpgEntity
//                => this.Add(new Turn(), initiator, OutcomeProp, sourceExpr);
...
//            where TInitiator : RpgEntity
//                => this.Add(new Turn(), initiator, OutcomeProp, source, sourceExpr);

//        public OutcomeModSet Outcome<TInitiator>(TInitiator initiator, string sourceProp)
//            where TInitiator : RpgEntity
//                => this.Add(new Turn(), initiator, OutcomeProp, sourceProp);
//    }
//}
