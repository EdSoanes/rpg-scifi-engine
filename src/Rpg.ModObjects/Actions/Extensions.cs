...
namespace Rpg.ModObjects.Actions
{
    internal static class Extensions
    {
            ...
            where T : ModObject
        {
            ...
            foreach (var method in methods) 
            {
                ...
                var args = method.GetParameters()
                    .Select(x => GetModObjectActionArg(x, attrs.ToArray()))
                    .Where(x => x != null)
                    .Cast<ModCmdArg>()
                    .ToArray();
        ...
        private static bool IsModObjectAction(this MethodInfo method)
        {
            return method.ReturnType == typeof(ModObjects.ModAction)
                && method.GetCustomAttributes<ModCmdAttribute>().Any();
        }

        private static ModCmdArg? GetModObjectActionArg(this ParameterInfo parameterInfo, ModCmdArgAttribute[] attrs)
        {
